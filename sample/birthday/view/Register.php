...
<html>
   ...
   <body>
        ...
        <table align="right" cellpadding = "10">
           ...
           <td>Gender</td>
           <td>
               <input type="radio" name = "gender" id = " male" value="male">Male</input><div id = "gError"></div>
               <input type="radio" name = "gender" id = "female" value="female">Female</input><div id = "gError"></div>
           </td>
           </tr>
            <tr>
                <td>Nationality:</td>
