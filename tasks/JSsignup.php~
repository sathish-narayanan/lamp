 	...
 	<head>  <title>Gmail</title>
		...
		<body>
			<h1 align="center">Gmail</h1>
					...
					<td>First Name</td>
					<td>
				    <input id="fname" name="firstname" title="enter your first name" type="text" onblur = "return username(id) " />
					</td>
					</tr>
 					<tr>
					<td>Last Name</td>
					<td>
				    <input id="lname" name="lastname" title="enter your last name" type="text" onblur = "return username(id)"/> 
			        </td>
					</tr>
 					<tr>
					<td>Date Of Birth</td>
					                    ...
					                    <tr>
	                     				<tr>
                                        <td>re-Password</td>
                                        <td> <input  id = "confirm_password" name="reenter_password"title="enter the pass word" 
                                        type="password"
                                        maxlength="12" onblur="return checkEmptybox(id)"></td>    
					                    <tr>
					                    <td>Mobile no</td>
